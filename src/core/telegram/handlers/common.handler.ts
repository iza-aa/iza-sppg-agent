...
export async function sendPanduan(bCtx: BotContext, ctx: Context) {
  ...
  const panduanLines = [
    `📖 <b>PANDUAN PERINTAH ASISTEN SPPG</b>`,
    `Unit: <b>${escapeHtml(bCtx.unitConfig.name)}</b>`,
    `------------------------------------------`,
    ``,
    `🏛️ <b>1. TRANSAKSI INDUK (Header / Nota Utama)</b>`,
    `<b>• PENDAPATAN / PAGU (Tab 02):</b>`,
    `  - <i>Catat Baru:</i> <code>Catat pesanan SPPG No PO-... tanggal ... menu ... : - Bahan 1 ...</code>`,
    `  - <i>Daftar PO:</i> <code>pagu</code> | <code>daftar pendapatan</code>`,
    `  - <i>Detail PO:</i> <code>detail II001</code> | <code>lihat II001</code>`,
    `  - <i>Hapus Induk:</i> <code>hapus pagu II001</code> (hapus nota + cascade rincian)`,
    ``,
    `<b>• PENGELUARAN / BELANJA (Tab 04):</b>`,
    `  - <i>Catat Belanja:</i> <code>Beli ayam 120 kg @ 36000 di Toko Berkah tunai</code>`,
    `  - <i>Foto Bon/Struk:</i> Kirim langsung foto nota belanja (OCR Otomatis)`,
    `  - <i>Daftar Belanja:</i> <code>transaksi</code> | <code>daftar belanja</code>`,
    `  - <i>Hapus Induk:</i> <code>hapus belanja EI001</code> (hapus faktur + cascade rincian)`,
    ``,
    `🥗 <b>2. RINCIAN BAHAN (Child / Per Item Komoditas)</b>`,
    `<b>• RINCIAN PENDAPATAN (Tab 03):</b>`,
    `  - <i>Lihat Bahan:</i> <code>rincian pagu II001</code>`,
    `  - <i>Tambah Bahan:</i> <code>tambah rincian pagu II001 Wortel 20 kg @ 15000 supplier Berkah</code>`,
    `  - <i>Ubah Kuantitas/Harga:</i> <code>ubah kuantitas ayam di II001 jadi 150 kg</code>`,
    `  - <i>Hapus 1 Bahan:</i> <code>hapus rincian ayam dari II001</code> (nota induk aman)`,
    ``,
    `<b>• RINCIAN PENGELUARAN (Tab 05):</b>`,
    `  - <i>Lihat Belanja:</i> <code>rincian belanja EI001</code>`,
    `  - <i>Tambah Item:</i> <code>tambah rincian belanja EI001 Minyak 10 liter @ 16000</code>`,
    `  - <i>Ubah Item:</i> <code>ubah belanja telur di EI001 jadi 50 kg</code>`,
    `  - <i>Hapus 1 Item:</i> <code>hapus rincian telur dari EI001</code> (nota induk aman)`,
    ``,
    `📊 <b>3. LAPORAN, REKAP & PENGATURAN</b>`,
    `• <code>rekap</code> | <code>margin</code> — Ringkasan efisiensi margin harian`,
    `• <code>pdf</code> | <code>cetak spj</code> — Download dokumen SPJ resmi (PDF)`,
    `• <code>sheets</code> — Link langsung ke Google Sheets Dapur`,
    `• <code>/invite [Nama] [admin/member]</code> — Buat link undangan staf`,
    ``,
    `------------------------------------------`,
