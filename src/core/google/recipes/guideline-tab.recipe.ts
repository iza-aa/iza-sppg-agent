...
export function getGuidelineTabValues(unitName = "SPPG Dapur Unit"): (string | number)[][] {
  return [
    ...
    // R6-R11: Tab Rows
    ["Tab 01", SHEET_NAMES.DASHBOARD, "Otomatis (Formula)", "Menampilkan KPI eksekutif, total anggaran pagu, realisasi belanja, sisa anggaran, dan chart tren", "DILARANG EDIT: Seluruh angka dihitung otomatis oleh formula, jangan ubah isi sel", "Menghubungkan data dari Tab 02 & Tab 04"],
    ["Tab 02", SHEET_NAMES.PENDAPATAN, "Induk Anggaran (Input)", "Mencatat Surat Pesanan resmi BGN, nomor PO, tanggal menu, batas plafon anggaran belanja", "Dicatat oleh bot saat menerima pesanan pagu baru dari Telegram atau input resmi SPPG", "Data Induk Utama: Terhubung ke Tab 03, 04, 05, 06"],
    ["Tab 03", SHEET_NAMES.RINCIAN_PENDAPATAN, "Rincian Pagu (Child)", "Merinci kuantitas, satuan, dan plafon harga maksimal per komoditas bahan baku resmi BGN", "DILARANG EDIT MANUAL: Disinkronkan otomatis dari Tab 02 atau via bot", "Terikat mutlak dengan No SPPG Tab 02"],
    ["Tab 04", SHEET_NAMES.PENGELUARAN, "Ringkasan Nota (Formula)", "Mencatat faktur/nota induk supplier, nomor nota, tanggal, supplier, dan total nominal tagihan", "FORMULA OTOMATIS: Total tagihan (Col F) otomatis menjumlahkan rincian di Tab 05", "Terikat dengan Tab 05 (Hapus nota = hapus rincian)"],
    ["Tab 05", SHEET_NAMES.RINCIAN_PENGELUARAN, "Rincian Belanja (Input)", "Mencatat item bahan belanjaan riil dari pasar/supplier, kuantitas, harga faktur, dan bukti nota", "INPUT BOT / SHEET: Masuk otomatis saat staf kirim chat/foto struk nota ke bot", "Mengisi realisasi Tab 06 & mengakumulasi total Tab 04"],
    ["Tab 06", SHEET_NAMES.MARGIN, "Evaluasi Margin (Live)", "Komparasi berdampingan antara pagu resmi vs realisasi belanja riil dan evaluasi laba/rugi", "OTOMATIS: Dihitung secara live per komoditas bahan, mendeteksi HEMAT / OVER BUDGET", "Memantau efisiensi anggaran & batas margin SPPG"],
    // R12: Blank
    ["", "", "", "", "", ""],
